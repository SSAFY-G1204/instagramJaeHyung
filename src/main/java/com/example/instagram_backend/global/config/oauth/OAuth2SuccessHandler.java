...
import com.example.instagram_backend.domain.UserInfoManagement.util.CookieUtil;
import com.example.instagram_backend.global.config.jwt.TokenProvider;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        Map<String, Object> UserResponse = (Map<String, Object>)oAuth2User.getAttributes().get("response");
        User user = userService.findByEmail((String) UserResponse.get("email"));
